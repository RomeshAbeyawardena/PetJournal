...
{
	// Mixin Content Type with alias "dashboard"
	/// <summary>Dashboard</summary>
	public partial interface IDashboard : IPublishedContent
	{
	}

	/// <summary>Dashboard</summary>
	[PublishedModel("dashboard")]
	public partial class Dashboard : PublishedContentModel, IDashboard
	{
		// helpers
